...
#
# ```
# docker network create suydtdjereo_net
# docker image pull --platform linux/amd64 <registry>/<image>:<tag>
#
# docker run --detach --name suydtdjereo \
#     --user root \
#     --env-file /etc/suydtdjereo/.env \
#     --env PORT=8000 \
#     --network suydtdjereo_net \
#     --publish 8000:8000 \
#     --volume suydtdjereo_static:/app/static \
#     <registry>/<image>:<tag>
# ```
#
...
CMD ["sh", "-c", "gunicorn --bind 0.0.0.0:$PORT suydtdjereo.wsgi:application"]
