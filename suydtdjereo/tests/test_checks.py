...
class TestDevModeCheck(SimpleTestCase):
    ...
    def test_fail_not_dev_mode(self):
        ...
        self.assertEqual(result[0].id, "suydtdjereo.W001")


@isolate_apps("suydtdjereo", attr_name="apps")
