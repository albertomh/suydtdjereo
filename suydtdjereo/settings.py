"""
Django settings for suydtdjereo.

Generated by djereo v3.7.2-6-g6f85411 based on Django 5.2's 'django-admin startproject'.
...
from suydtdjereo.logging import LoggingConfigFactory
...
FIRST_PARTY_APPS = [
    "suydtdjereo.apps.SuydtdjereoConfig",
    "users.apps.UsersConfig",
]
if IS_TESTING:
    FIRST_PARTY_APPS += ["suydtdjereo.tests.test_app.apps.TestAppConfig"]
THIRD_PARTY_APPS = [
    "allauth",
    "allauth.account",
...
MIDDLEWARE = [
    "suydtdjereo.middleware.SecurityHeadersMiddleware",
    ...
    # Look inside the `templates/` subdirectory of each Django app.
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "suydtdjereo.context_processors.metadata",
            ],
        },
    },
]

WSGI_APPLICATION = "suydtdjereo.wsgi.application"
...
TEST_RUNNER = "suydtdjereo.test.TestRunner"
